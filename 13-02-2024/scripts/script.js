import { ExpenseTrackerUtils, Category } from "./expenceTracker.js";
document.addEventListener("DOMContentLoaded", () => {
    ...
    const loadCategoriesToDropdown = () => {
        Object
            ...
            inpCategoryEl === null || inpCategoryEl === void 0 ? void 0 : inpCategoryEl.appendChild(option1El);
            categoryFilterEl === null || categoryFilterEl === void 0 ? void 0 : categoryFilterEl.appendChild(option2El);
        });
    };
    // const optionEl = inpCategoryEl?.appendChild
    const loadExpenses = (category = "") => {
        //myExpenseTools.loadFromLocalStorage()
        expenseHistoryEl === null || expenseHistoryEl === void 0 ? void 0 : expenseHistoryEl.replaceChildren();
        myExpenseTools.getAllExpenses(category).forEach(({ amount, category, date, description }) => {
            ...
            expenseHistoryEl === null || expenseHistoryEl === void 0 ? void 0 : expenseHistoryEl.appendChild(expenseEl);
        });
    ...
    expenseFormEl === null || expenseFormEl === void 0 ? void 0 : expenseFormEl.addEventListener("submit", (e) => handleSubmitExpense(e));
    categoryFilterEl === null || categoryFilterEl === void 0 ? void 0 : categoryFilterEl.addEventListener("change", (e) => { loadExpenses(e.target.value); });
